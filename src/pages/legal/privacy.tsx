		...
		<Layout>
			<Container>
				<div className="mt-10 font-serif prose">
					...
					<p className="mt-4">Last updated: July 13, 2023</p>
					<p className="mt-4">
					...
					<h1 className="">Interpretation and Definitions</h1>
					...
					<ul>
						...
						<li>
							<p>
								...
								or &quot;Our&quot; in this Agreement) refers to Templately.
							</p>
						</li>
						<li>
							<p>
						...
						<li>
							<p>
								<strong>Website</strong> refers to Templately, accessible from{' '}
								<a href="https://www.templately.co.uk" rel="external nofollow noopener" target="_blank">
									https://www.templately.co.uk
								</a>
							</p>
						</li>
						<li>
					...
					<h1 className="">Collecting and Using Your Personal Data</h1>
					<h2 className="">Types of Data Collected</h2>
					<h3>Personal Data</h3>
					<p>
					...
					<h2 className="">Use of Your Personal Data</h2>
					...
					<h2 className="">Retention of Your Personal Data</h2>
					<p>
					...
					<h2 className="">Transfer of Your Personal Data</h2>
					<p>
					...
					<h2 className="">Delete Your Personal Data</h2>
					<p>
					...
					<h2 className="">Disclosure of Your Personal Data</h2>
					...
					<h2 className="">Security of Your Personal Data</h2>
					<p>
					...
					<h1 className="">Children&apos;s Privacy</h1>
					<p>
					...
					<h1 className="">Links to Other Websites</h1>
					<p>
					...
					<h1 className="">Changes to this Privacy Policy</h1>
					<p>
