export const questions = [
	...
	{
		question: 'What does Templately.co.uk offer?',
		answer: (
			<>
				Templately.co.uk is a platform that provides a vast selection of community-sourced email templates, enhanced
				with ChatGPT integration for automation. Our aim is to supercharge your email creation and improve efficiency.
			</>
		),
	},
	{
	...
	},
	{
		...
		answer: (
			<>
				If you wish to delete your account, please send us an email at contact@templately.co.uk. Upon receiving your
				confirmation, we will proceed with the deletion process.
			</>
		),
	},
	{
		question: 'How can I contact Templately?',
		answer: (
			<>Reach out to Templately by sending us an email at contact@templately.co.uk. We look forward to assisting you.</>
		),
	},
	{
